...
st.sidebar.title("🎬 Netflix: La evolución del entretenimiento global")
st.sidebar.markdown("Exploración visual del catálogo de Netflix")
...
if menu == "🏠 Inicio":
    ...
    st.subheader("La evolución del entretenimiento global")
...
# ============================================================
    ...
    **Por qué:**  
    ...
    - Evita que `"India"` y `" India"` se consideren países distintos, por ejemplo.
    """)
...
# ============================================================
    ...
    df_vista = df.copy()
    df_vista["date_added"] = df_vista["date_added"].astype(str)
    st.write(df_vista.head())
    ...
    with col1:
        ...
        Directores como *Rajiv Chilaka* y *Raúl Campos* dominan la producción dentro de categorías específicas, 
        como el contenido infantil y los especiales de comedia.""")
    ...
    with col2:
        ...
        st.markdown("""**Observaciones:**  
        Estados Unidos lidera la producción de contenido con más de **4,500 títulos**, seguido de India y Reino Unido.""")
    ...
    st.markdown("""**Observaciones:**  
    Netflix experimentó un **crecimiento exponencial** a partir de 2013, con pequeñas caídas en 2012 y 2019.""")
